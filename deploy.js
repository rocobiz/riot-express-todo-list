...
function cloneRepo() {
	...
	cmd.get(
		'rm -rf riot-express-todo-list && git clone https://github.com/rocobiz/riot-express-todo-list.git',
...
function transferProjectToRemote(failed, successful) {
	return ssh.putDirectory(__dirname + '/riot-express-todo-list', '/home/ubuntu/riot-express-todo-list', {
		recursive: true,
		concurrency: 1,
...
function sshConnect() {
	...
	ssh.connect({
		...
		host: '13.58.13.66',
		username: 'ubuntu',
		privateKey: 'C:/Users/rcollins/mykey/hs2-key.pem'
	})
	.then(function() {
